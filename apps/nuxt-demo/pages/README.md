...
::LinkExample{link="https://nuxt.com/docs/examples/routing/pages"}
::
...
You can set a default value for this property [in your `nuxt.config`](https://nuxt.com/docs/api/configuration/nuxt-config#keepalive).
...
You can set default values for these properties [in your `nuxt.config`](https://nuxt.com/docs/api/configuration/nuxt-config#layouttransition).
...
:ReadMore{link="https://nuxt.com/docs/guide/going-further/custom-routing"}
...
:ReadMore{link="https://nuxt.com/docs/guide/going-further/layers"}
